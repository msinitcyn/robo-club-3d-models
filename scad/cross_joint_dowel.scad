...
union() {
    difference() {
        ...
        cut_wall_opening(3, center_size, groove_width, wall_height, wall_thickness);
    }
    ...
    attach_sleeve(3, sleeve_length, total_width, groove_width, wall_height, wall_thickness, center_size);
