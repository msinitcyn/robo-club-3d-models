...
// Крестовина со штырями и гибкими стенками (4 выхода)
...
union() {
    ...
    // Рукава на всех четырех сторонах с гибкими стенками (со штырями)
    ...
    place_sleeve(3, with_dowel = true, wall_type = "flexible");  // назад
}
